    ...
    <div class="patag-gradient text-white">
      ...
      <div class="max-w-6xl mx-auto px-6 pb-10">
        ...
        <form class="mt-6 flex flex-col md:flex-row gap-3 justify-center" action="{{ route('officials.index') }}" method="GET">
          <input class="w-full md:w-72 rounded-full px-4 py-3 text-sm text-[#2a1c14]" placeholder="Search Government Official or Keyword" aria-label="Search government official or keyword" />
          <input class="w-full md:w-48 rounded-full px-4 py-3 text-sm text-[#2a1c14]" placeholder="Location" aria-label="Location" />
