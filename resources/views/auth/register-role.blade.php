<x-layouts.app :title="'PATAG | Role Selection'">
  <div class="min-h-screen patag-gradient flex items-center justify-center px-6 py-16">
    <div class="patag-panel rounded-3xl p-10 w-full max-w-2xl text-white shadow-soft">
      <a href="{{ route('register') }}" class="text-xs px-3 py-1 rounded-full bg-white/10 inline-flex">Back</a>
      ...
      <div class="grid md:grid-cols-3 gap-4 mt-8">
        <a href="{{ route('register.citizen') }}" class="rounded-2xl bg-white/10 border border-white/10 p-4 block">
        ...
        <a href="{{ route('register.researcher') }}" class="rounded-2xl bg-white/10 border border-white/10 p-4 block">
        ...
        <a href="{{ route('register.journalist') }}" class="rounded-2xl bg-white/10 border border-white/10 p-4 block">
          <p class="font-semibold">Journalist / Media</p>
          <p class="text-xs text-white/70 mt-2">Get real-time data and verified sources.</p>
        </a>
      </div>
      <a href="{{ route('dashboard') }}" class="w-full bg-black/40 hover:bg-black/60 text-white py-3 rounded-xl font-semibold mt-8 block text-center">Continue</a>
